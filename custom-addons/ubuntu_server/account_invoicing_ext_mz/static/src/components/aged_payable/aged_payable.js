...
export class AgedPayableReport extends Component {
    static template = "account_invoicing_ext_mz.AgedPayableReport";
    ...
    async loadReport() {
        try {
            ...
            const result = await this.rpc("/web/dataset/call_kw/account.aged.payable.report/get_aged_payable_data", {
                model: "account.aged.payable.report",
                method: "get_aged_payable_data",
                args: [],
                kwargs: {
            ...
            console.error("Error loading aged payable:", error);
    ...
    async exportToPDF() {
        try {
            await this.action.doAction({
                ...
                report_name: 'account_invoicing_ext_mz.aged_payable_report',
                report_file: 'account_invoicing_ext_mz.aged_payable_report',
                data: {
    ...
    async exportToXLSX() {
        try {
            await this.action.doAction({
                type: 'ir.actions.report',
                report_type: 'xlsx',
                report_name: 'account_invoicing_ext_mz.aged_payable_xlsx',
                report_file: 'account_invoicing_ext_mz.aged_payable_xlsx',
                data: {
                    partners: this.state.partners,
                    totals: this.state.totals,
                    periods: this.state.periods,
...
registry.category("actions").add("account_aged_payable_report", AgedPayableReport);